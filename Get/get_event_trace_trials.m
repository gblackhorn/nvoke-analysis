function [alignedData_allTrials,varargout] = get_event_trace_trials(trialsData,varargin)
% Collect the event traces from multiple trials or a single trial. Return a struct
