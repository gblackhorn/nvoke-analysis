function [APspikeTraces, spontSpikeTraces] = plotAPstimSpontSpikesSeparatelyForROI (trialData, ROI)
PREwin = 10; 
POSTwin = 100;
...
title (['ROI n ' num2str(ROI) ', airpuff-evoked spikes']);

subplot (1, 2, 2); hold on;
plot(spontSpikeTraces, 'b');
plot(mean(spontSpikeTraces', 'omitnan'), 'r', 'LineWidth', 3);
title (['ROI n ' num2str(ROI) ', spontaneous spikes']);
