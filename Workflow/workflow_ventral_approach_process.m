...
opt.criteria_rise_time = [0 4]; % unit: second. filter to keep peaks with rise time in the range of [min max]
...
opt.criteria_rebound = opt.criteria_rise_time(2); % If an event found in this time range after the end of stimualtion, it will be categorized as an rebound/off-stim event
