...
opt.criteria_excitated = 1+opt.criteria_rise_time(2); % If an event found in this time range after the onset of stimulation, it will be categorized as an exitated/trig event
