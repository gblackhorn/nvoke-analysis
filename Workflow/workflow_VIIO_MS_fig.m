...
filterROIs = true; % true/false. If true, screen ROIs
StimTags = {'og-5s','ap-0.1s','og-5s ap-0.1s'}; % {'og-5s','ap-0.1s','og-5s ap-0.1s'}. compare the alignedData.stim_name with these strings and decide what filter to use
...
% Discard ROIs without sync tag in the eventProp (Due to low number of ROIs)
mustHaveField = 'type';
