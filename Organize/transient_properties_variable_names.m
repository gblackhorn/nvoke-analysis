function [transient_properties_variable_names] = transient_properties_variable_names(output_type, varargin)
    ...
    % Defaults
    transient_properties_variable_names = {'peak_loc', 'peak_val','peak_mag', 'rise_loc', 'rise_val','decay_loc',...
    'peak_time', 'rise_time', 'decay_time', 'rise_duration', 'decay_duration', 'FWHM', 'peak_mag_delta',...
