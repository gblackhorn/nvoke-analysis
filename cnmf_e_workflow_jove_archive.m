...
tsub = 1;           % default:1. temporal downsampling factor
...
patch_par = [1,1]*1; %1;  % default=[1,1]*1. divide the optical field into m X n patches and do initialization patch by patch. It can be used when the data is too large 
